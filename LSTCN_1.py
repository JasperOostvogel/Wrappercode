...
class LSTCN(MultiOutputMixin, BaseEstimator):
    ...
    def __init__(self, n_features, n_steps, W1 = None, n_blocks=5, function='hyperbolic', solver='svd', alpha=1e-2):
    ...
    def fit(self, X_train, Y_train):
        ...
        init_matrix = -0.5 + np.random.rand(
            self.n_steps * self.n_features, self.n_steps * self.n_features)
